  ...
  return (
    <div className="min-h-screen flex flex-col bg-white" style={{ fontFamily: "'Source Sans Pro', arial, sans-serif" }}>
      ...
      <main className="max-w-5xl mx-auto w-full flex flex-col items-center justify-center py-8 px-4">
        <h1 className="text-2xl md:text-3xl font-bold tracking-wider text-center mb-8 mt-8 uppercase" style={{ letterSpacing: 1 }}>CANCELLATION & NO CALL / NO SHOW POLICY</h1>
        ...
        <div className="w-full max-w-3xl bg-white text-center py-4 px-2 mb-4">
          <span className="uppercase text-xs md:text-sm font-semibold tracking-widest text-black">CALL US TODAY TO BOOK YOUR SKIN CARE AND SPA TREATMENT.</span>
        </div>
        <div className="w-full max-w-3xl text-center text-[15px] md:text-base text-black flex flex-col gap-4">
